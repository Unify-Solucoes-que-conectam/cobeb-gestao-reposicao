    ...
    >
      <div className='flex justify-between items-start p-4 gap-4'>
        ...
        <div className='flex flex-col items-end gap-2 shrink-0'>
          ...
          >
            {cliente.quantidade_notas || 0} NFs
          </Badge>

          <Badge
            className={`text-xs font-bold border-none rounded-full px-2.5 py-0.5 tracking-wide shadow-none uppercase ${cliente.status === 'inativo'
