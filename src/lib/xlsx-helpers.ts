...
export const IMPORTER_CONFIGS: ImporterConfig[] = [
  ...
  },
  {
    ...
    tableName: "clientes",
    columns: [
      { header: "Código", key: "codigo", example: "CLI001" },
      ...
      { header: "Endereço", key: "endereco", example: "Rua A, 123" },
  ...
  },
  {
    ...
    columns: [
      ...
      { header: "Nome", key: "nome", example: "José Silva" },
  ...
  },
  {
    ...
    columns: [
      { header: "Número", key: "numero", example: "NF001" },
      ...
      { header: "Valor Total", key: "valor_total", example: "1400.00" },
